    ...
    <tbody class="text-sm text-gray-700 dark:text-gray-200">
      @forelse ($products as $product)
        <tr class="border-b dark:border-gray-700">
          ...
          <td class="px-4 py-2">AED {{ number_format($product->price, 2) }}</td>
          <td class="px-4 py-2">
      ...
      @empty
        <tr>
          <td colspan="11" class="px-4 py-4 text-center text-gray-500 dark:text-gray-400">No products found.</td>
        </tr>
      @endforelse
    </tbody>
  </table>
